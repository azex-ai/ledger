...
import { type LinkComponent } from "../components/nav";
 ...
 *
 * It self-mounts HeroUI's <Toast.Provider/> so the convenience all-in-one
 * shows toast feedback out of the box. The chart pages are lazy-loaded behind
 * <Suspense> to keep recharts off the root barrel.
 *
