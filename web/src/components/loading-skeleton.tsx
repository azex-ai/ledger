  ...
  return (
    <div className="flex items-center justify-between">
      <div>
        ...
        <div className="mt-1 h-4 w-72 animate-shimmer rounded" />
      </div>
      {hasActions && <div className="h-9 w-20 animate-shimmer rounded" />}
    </div>
  );
}
...
export function FilterSkeleton() {
  return <div className="h-10 w-40 animate-shimmer rounded" />;
}
