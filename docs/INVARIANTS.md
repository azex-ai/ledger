...
## I-42: A classification's normal_side is interpreted in exactly one place, on each side of the language boundary, and an unrecognized value is refused rather than defaulted
