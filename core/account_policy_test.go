...
// TestSign_RejectsUnknownNormalSideAndEntryType is the I-42 pin: Sign is the
...
// TestDelta_RejectsUnknownNormalSide is the I-42 pin for the aggregate
...
// classifying an unknown normal_side as a decrease (its pre-I-42 behavior:
