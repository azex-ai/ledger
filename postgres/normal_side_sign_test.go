...
// I-43 pins: the sign convergence collapsing 17 independent
...
//
// See docs/INVARIANTS.md I-43 and
...
// the I-43 pin: an unrecognized normal_side must raise, not fall through to
...
func TestNormalSideDomain_StructurallyClosedByCheckConstraints(t *testing.T) {
	...
	t.Run("journal_entries.entry_type", func(t *testing.T) {
		cur := postgrestest.SeedCurrency(t, pool, "I42BADENTRY", "I-43 bad entry currency")
		cls := postgrestest.SeedClassification(t, pool, "i42_bad_entry_cls", "Bad Entry Cls", "debit", false)
		jt := postgrestest.SeedJournalType(t, pool, "i42_bad_entry_jt", "I-43 bad entry journal type")
